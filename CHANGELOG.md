...
### Fixed
- We fixed an issue with CSV export where some fields were not going to proper columns if they contained quotation marks [#9087](https://github.com/JabRef/jabref/issues/9087)
