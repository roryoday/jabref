...
- We modified getDescription in FieldNameLabel to remove contol flow warning
- We modified the switch statement in generateSymmetricHighlighting() to remove warning
